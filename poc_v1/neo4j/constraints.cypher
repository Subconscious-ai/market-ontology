...
CREATE CONSTRAINT trait_id IF NOT EXISTS FOR (n:Trait) REQUIRE n.id IS UNIQUE;
CREATE CONSTRAINT trait_level_id IF NOT EXISTS FOR (n:TraitLevel) REQUIRE n.id IS UNIQUE;
...
CREATE CONSTRAINT trait_name_required IF NOT EXISTS FOR (n:Trait) REQUIRE n.name IS NOT NULL;
...
CREATE INDEX trait_name IF NOT EXISTS FOR (n:Trait) ON (n.name);
...
CREATE INDEX trait_level_valid_from IF NOT EXISTS FOR (n:TraitLevel) ON (n.valid_from);
